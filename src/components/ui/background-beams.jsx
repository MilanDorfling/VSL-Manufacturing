...
export const BackgroundBeams = React.memo(({ className, animated = true }) => {
  ...
  return (
    ...
    >
      ...
      >
        {/* Static background beams: faint lines for each path. */}
        ...
        <defs>
          ...
          {animated && animatedPaths.map((path, index) => (
            ...
            >
              ...
              <stop stopColor="#18CCFC"></stop> {/* Blue, solid */}
              <stop offset="32.5%" stopColor="#1e40af"></stop> {/* White */}
              <stop offset="100%" stopColor="#1e40af" stopOpacity="0"></stop> {/* White, transparent at end */}
            </motion.linearGradient>
          ))}
          {/* Radial gradient for static background beams. Change stopColor values for different background effects. */}
          <radialGradient
          ...
          >
            <stop offset="0.0666667" stopColor="#d4d4d4"></stop> {/* Light gray, center */}
            <stop offset="0.243243" stopColor="#d4d4d4"></stop> {/* Light gray, mid */}
            <stop offset="0.43594" stopColor="white" stopOpacity="0"></stop> {/* Transparent white, edge */}
          </radialGradient>
        </defs>
      </svg>
    </div>
